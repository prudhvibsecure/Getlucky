...
public class StoreListCashbackAdapter extends RecyclerView.Adapter<StoreListCashbackAdapter.ContactViewHolder> {
    ...
    public StoreListCashbackAdapter(List<StoreListModel> list, Context context, StoreAdapterListener listener) {
