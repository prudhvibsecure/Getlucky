...
public class OperatorListAdapter extends RecyclerView.Adapter<OperatorListAdapter.ContactViewHolder> {
    ...
    public OperatorListAdapter(List<OperatorModel> list, Context context, OperatorListAdapterListener listener) {
