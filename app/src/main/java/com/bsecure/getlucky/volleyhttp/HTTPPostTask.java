...
import com.bsecure.getlucky.common.CacheManager;
import com.bsecure.getlucky.common.Item;
import com.bsecure.getlucky.interfaces.IItemHandler;
import com.bsecure.getlucky.utils.LogUtils;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String requestUrl = urlEncode(urlKey);
                    ...
                    if (serverResponseCode == 200) {
                        ...
                        logRequestLocally(mContext, urlKey, postData, "", obj, "", "", 0);
                    ...
                    logRequestLocally(mContext, urlKey, postData, "", "", "ConnectException", me.getLocalizedMessage()+"", 0);
                    ...
                    logRequestLocally(mContext, urlKey, postData, "", "", "ConnectException", e.getLocalizedMessage()+"", 0);
                    ...
                    logRequestLocally(mContext, urlKey, postData, "", "", "SocketException", se.getLocalizedMessage()+"", 0);
                    ...
                    logRequestLocally(mContext, urlKey, postData, "", "", "SocketTimeoutException", stex.getLocalizedMessage()+"", 0);
                    ...
                    logRequestLocally(mContext, urlKey, postData, "", "", "Exception", ex.getLocalizedMessage()+"", 0);
