...
public abstract class RecyclerViewSwipeHelper extends ItemTouchHelper.SimpleCallback {
        ...
        if(actionState == ItemTouchHelper.ACTION_STATE_SWIPE){
            if(dX < 0) {
                ...
                if (!buttonsBuffer.containsKey(pos)){
                    instantiateUnderlayButton(viewHolder, buffer,pos);
    ...
    public abstract void instantiateUnderlayButton(RecyclerView.ViewHolder viewHolder, List<UnderlayButton> underlayButtons,int mPostion);
